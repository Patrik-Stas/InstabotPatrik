...
class ItShouldUpdateUserWhenWeLikeHisMedia(CoreDBInteractionsTestCase):
    ...
    def runTest(self):
        ...
        self.assertEquals(user.count_likes_we_gave + 1, user_loaded.count_likes_we_gave)
        self.assertEquals(datetime.datetime(year=2017, month=11, day=11, hour=11, tzinfo=pytz.UTC), user_loaded.dt_like)
        ...
        self.assertEquals(user.we_follow_user, user_loaded.we_follow_user)
